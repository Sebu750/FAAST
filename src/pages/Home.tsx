...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-neutral-100 selection:bg-[#bb9457] selection:text-black font-sans antialiased overflow-x-hidden">
      ...
      <div className="w-full bg-[#bb9457] text-black font-mono text-[10px] tracking-[0.35em] uppercase py-3 px-6 sticky top-0 z-50 flex justify-between items-center border-b border-black/5 backdrop-blur-md">
      ...
      <section className="relative overflow-hidden border-b border-neutral-900 bg-black min-h-screen flex items-center">
          ...
          {slides.map((slide, index) => (
            <img
              ...
              className={`absolute inset-0 h-full w-full object-cover transition-all duration-[1400ms] cubic-bezier(0.25, 1, 0.5, 1) ${
                index === currentIndex ? 'opacity-45 scale-100 animate-ambient-swell' : 'opacity-0 scale-105'
              }`}
            />
          ))}
        </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-8 py-32">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-3 border border-white/10 bg-white/[0.02] backdrop-blur-md px-4 py-2 rounded-full mb-8 transform translate-y-4 animate-fade-in">
            ...
            <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.05] tracking-tight text-white font-normal transition-all duration-700">
              {slides[currentIndex].title.split(' ').map((word, i) => {
                ...
                return (
                  <span key={i} className={target ? 'text-[#bb9457] italic font-light block md:inline' : ''}>
                    {word}{' '}
                  </span>
                );
              })}
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-8">
              ...
              <h2 className="font-serif text-4xl md:text-6xl text-neutral-900 font-normal tracking-tight leading-[1.15]">
                Pakistan is not emerging. It has <span className="text-[#bb9457] italic font-light">always been here.</span>
              </h2>
            ...
            <div className="lg:col-span-5 relative group overflow-hidden rounded-sm bg-neutral-100 border border-neutral-200">
              ...
              <img 
                ...
                className="w-full aspect-[4/5] object-cover filter grayscale contrast-125 group-hover:scale-105 transition-transform duration-[1.5s] ease-out"
              />
              <div className="absolute bottom-6 left-6 z-20 text-white font-mono text-[10px] tracking-widest uppercase bg-black/60 px-4 py-2 backdrop-blur-md">
                The Cultural Reset
              </div>
            </div>
          </div>
      ...
      <section className="bg-neutral-950 text-white py-32 border-b border-neutral-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={pillar.title} className="p-10 border border-neutral-900 bg-neutral-950 hover:border-[#bb9457]/50 transition-all duration-300 rounded-sm flex flex-col justify-between">
                <div>
                  <h3 className="font-serif text-2xl text-white font-normal mb-4">{pillar.title}</h3>
                  <p className="text-neutral-400 text-sm leading-relaxed font-light mb-8">{pillar.body}</p>
                </div>
                <Link to={pillar.link} className="text-[#bb9457] uppercase tracking-wider font-semibold text-xs border-b border-[#bb9457] pb-0.5 hover:text-white hover:border-white transition-colors">
                  {pillar.linkText}
                </Link>
              </div>
            ))}
      ...
      <section className="relative bg-[#6f1d1b] text-white py-40 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src={spotlight} alt="Background" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center space-y-8">
          <div className="text-[10px] uppercase tracking-[0.3em] text-[#bb9457] font-mono font-semibold">
          ...
          <div className="pt-6 flex flex-wrap justify-center gap-5">
            ...
            <Link
              to="/spotlight-event"
              className="px-8 py-4 border border-white/30 text-white font-semibold uppercase tracking-[0.20em] text-[11px] rounded-sm hover:border-[#bb9457] hover:text-[#bb9457] transition-all duration-300 backdrop-blur-md"
            >
      ...
      <section className="bg-neutral-950 text-white py-32 border-b border-neutral-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Designer 01", role: "Lahore" },
              { name: "Designer 02", role: "Karachi" },
              { name: "Designer 03", role: "Islamabad" }
            ].map((designer, idx) => (
              <div key={idx} className="aspect-[4/5] overflow-hidden rounded-sm bg-neutral-900 border border-neutral-800 group hover:border-[#bb9457]/50 transition-all duration-500">
                <img src={idx === 0 ? heroHome : idx === 1 ? studio : spotlight} alt={designer.name} className="w-full h-full object-cover filter grayscale contrast-125 group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                  <div className="text-white font-serif text-lg">{designer.name}</div>
                  <div className="text-[#bb9457] text-xs font-mono uppercase tracking-widest mt-1">{designer.role}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-16 text-center">
            <Link to="/for-creatives" className="px-8 py-4 border border-[#bb9457] text-[#bb9457] font-semibold uppercase tracking-[0.2em] text-[11px] rounded-sm hover:bg-[#bb9457] hover:text-black transition-all duration-300">
              Join the Community
            </Link>
          </div>
        </div>
      ...
      <section className="bg-white text-black py-32 border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5 order-last lg:order-first">
              <div className="aspect-[4/5] overflow-hidden rounded-sm bg-neutral-100 border border-neutral-200">
                <img 
                  src={studio} 
                  alt="Pakistani Heritage Craft" 
                  loading="lazy" 
                  className="w-full h-full object-cover filter grayscale contrast-125 hover:scale-105 transition-transform duration-[1.5s] ease-out" 
                />
              </div>
            </div>
            <div className="lg:col-span-7 space-y-8">
              ...
              <h2 className="font-serif text-4xl md:text-5xl text-neutral-900 font-normal tracking-tight leading-[1.15]">
                A design narrative the global stage has yet to <span className="text-[#bb9457] italic font-light">experience.</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.metric} className="text-center p-8 border border-neutral-900 bg-neutral-950/50 hover:border-[#bb9457]/30 transition-colors duration-300 rounded-sm">
                <div className="font-serif text-5xl md:text-6xl text-[#bb9457] font-light mb-3">{item.metric}</div>
      ...
      <section className="bg-neutral-950 text-white py-40 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10 space-y-8">
          ...
          <form className="max-w-lg mx-auto space-y-4">
            <input
              ...
              className="w-full px-6 py-4 bg-neutral-900 border border-neutral-800 text-white text-sm placeholder-neutral-500 rounded-sm focus:outline-none focus:border-[#bb9457] transition-colors duration-300"
            />
            <button
              type="submit"
              className="w-full px-8 py-4 bg-[#bb9457] text-black font-semibold uppercase tracking-[0.20em] text-[11px] rounded-sm hover:bg-white hover:text-black transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Request Access
            </button>
          </form>
