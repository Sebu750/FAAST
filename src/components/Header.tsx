      ...
      >
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            <Link to="/" className="text-base lg:text-lg font-serif text-white tracking-[0.25em] hover:text-[#bb9457] transition-all duration-300">
              ADORZIA
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-1">
              {[
                ...
                >
                  {label}
                  <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-px bg-[#bb9457] transition-all duration-400 ${
                    location.pathname === path ? 'w-4' : 'w-0 group-hover:w-4'
                  }`} />
                </Link>
              ))}
            </div>
            ...
            <button 
              ...
              className="lg:hidden relative w-10 h-10 flex items-center justify-center text-white hover:text-[#bb9457] transition-all duration-300"
              aria-label={mobileMenuOpen ? 'Close menu' : 'Open menu'}
            >
              <div className="relative w-5 h-4">
                <span className={`absolute left-0 w-full h-px bg-current transition-all duration-300 ${mobileMenuOpen ? 'top-1.5 rotate-45' : 'top-0'}`} />
                <span className={`absolute left-0 top-1.5 w-full h-px bg-current transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : 'opacity-100'}`} />
                <span className={`absolute left-0 w-full h-px bg-current transition-all duration-300 ${mobileMenuOpen ? 'top-1.5 -rotate-45' : 'top-3'}`} />
              </div>
            </button>
          </div>
        </nav>
          ...
          <div className="min-h-full px-6 py-8">
            ...
            <div className="flex flex-col space-y-2 mb-8">
              {[
                ...
                { label: 'Designers', path: '/designers', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
                { label: 'Features', path: '/blog', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
